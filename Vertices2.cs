...
namespace Hello_OpenTK
{
    public struct Carga
    {
        public static Objeto CargarTV(Vector3 Position = default) 
        {
            Objeto TV = new Objeto(Position);
            TV.m_Componentes = new Dictionary<string, Components>()
            {
                ["Soporte1"] = new Components(TV.m_Position + new Vector3(1.0f, 0.0f, 0.0f)),
            ...
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.25f, -0.875f, -0.125f), new Vector3(-0.25f,  -0.75f, -0.125f), new Vector3( 0.25f,  -0.75f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["Soporte1"].m_Position + TV.m_Componentes["Soporte1"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.25f, -0.875f, -0.125f), new Vector3( 0.25f, -0.875f, -0.125f), new Vector3( 0.25f,  -0.75f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["Soporte1"].m_Position + TV.m_Componentes["Soporte1"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["Soporte1"].m_Faces["Top"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.25f,  -0.75f, -0.125f), new Vector3(-0.25f, -0.75f,   0.125f), new Vector3( 0.25f, -0.75f,   0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["Soporte1"].m_Faces["Bottom"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.25f, -0.875f, -0.125f), new Vector3(-0.25f, -0.875f,  0.125f), new Vector3( 0.25f, -0.875f,  0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["Soporte2"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.0625f, -0.75f,   -0.125f), new Vector3(-0.0625f, -0.5625f, -0.125f), new Vector3( 0.0625f, -0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
               TV.m_Position + TV.m_Componentes["Soporte2"].m_Position + TV.m_Componentes["Soporte2"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.0625f, -0.75f,   -0.125f), new Vector3( 0.0625f, -0.75f,   -0.125f), new Vector3( 0.0625f, -0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                   TV.m_Position + TV.m_Componentes["Soporte2"].m_Position + TV.m_Componentes["Soporte2"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["Soporte2"].m_Faces["Front"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(0.0625f, -0.75f,    0.125f), new Vector3(0.0625f, -0.5625f,  0.125f), (-0.0625f, -0.5625f,  0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["Soporte2"].m_Position + TV.m_Componentes["Soporte2"].m_Faces["Front"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(0.0625f, -0.75f,    0.125f), new Vector3(-0.0625f, -0.75f,    0.125f), (-0.0625f, -0.5625f,  0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["Soporte2"].m_Position + TV.m_Componentes["Soporte2"].m_Faces["Front"].m_Position),
            };
            ...
            TV.m_Componentes["DownEdge"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, -1.0625f + 0.5f,    -0.125f), new Vector3(-0.5625f, -1.0625f + 0.5625f, -0.125f), new Vector3( 0.5625f, -1.0625f + 0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["DownEdge"].m_Position + TV.m_Componentes["DownEdge"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, -1.0625f + 0.5f,    -0.125f), new Vector3( 0.5625f, -1.0625f + 0.5f,    -0.125f), new Vector3( 0.5625f, -1.0625f + 0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["DownEdge"].m_Position + TV.m_Componentes["DownEdge"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["DownEdge"].m_Faces["Bottom"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3( 0.5625f, -1.0625f + 0.5f,    -0.125f), new Vector3(-0.5625f, -1.0625f + 0.5f,    -0.125f), new Vector3(-0.5625f, -1.0625f + 0.5f,     0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["LeftEdge"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, -0.5f, -0.125f), new Vector3(-0.5625f,  0.5f,  -0.125f), new Vector3(-0.5f,     0.5f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["LeftEdge"].m_Position + TV.m_Componentes["LeftEdge"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, -0.5f, -0.125f), new Vector3(-0.5f,    -0.5f, -0.125f), new Vector3(-0.5f,     0.5f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["LeftEdge"].m_Position + TV.m_Componentes["LeftEdge"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["LeftEdge"].m_Faces["Left"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, -0.5f, 0.125f), new Vector3(-0.5625f,  0.5f, 0.125f), new Vector3(-0.5625f,  0.5f,  -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["UpEdge"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, 0.5f,    -0.125f), new Vector3(-0.5625f, 0.5625f, -0.125f), new Vector3( 0.5625f, 0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["UpEdge"].m_Position + TV.m_Componentes["UpEdge"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, 0.5f,    -0.125f), new Vector3( 0.5625f, 0.5f,    -0.125f), new Vector3( 0.5625f, 0.5625f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["UpEdge"].m_Position + TV.m_Componentes["UpEdge"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["UpEdge"].m_Faces["Top"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f, 0.5625f, -0.125f), new Vector3(-0.5625f, 0.5625f,  0.125f), new Vector3(0.5625f,  0.5625f,  0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["RightEdge"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f + 1.0625f, -0.5f, -0.125f), new Vector3(-0.5625f + 1.0625f,  0.5f,  -0.125f), new Vector3(-0.5f + 1.0625f,     0.5f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                TV.m_Position + TV.m_Componentes["RightEdge"].m_Position + TV.m_Componentes["RightEdge"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5625f + 1.0625f, -0.5f, -0.125f), new Vector3(-0.5f + 1.0625f,    -0.5f, -0.125f), new Vector3(-0.5f + 1.0625f,     0.5f, -0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
                    TV.m_Position + TV.m_Componentes["RightEdge"].m_Position + TV.m_Componentes["RightEdge"].m_Faces["Back"].m_Position),
            };
            ...
            TV.m_Componentes["RightEdge"].m_Faces["Right"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5f + 1.0625f,    -0.5f, -0.125f), new Vector3(-0.5f + 1.0625f,     0.5f, -0.125f), new Vector3(-0.5f + 1.0625f,     0.5f, 0.125f)
                }, new Vector3(0.2f, 0.2f, 0.2f),
            ...
            TV.m_Componentes["Screen"].m_Faces["Front"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5f, -0.5f, 0.125f), new Vector3(-0.5f,  0.5f, 0.125f), new Vector3(0.5f,  0.5f, 0.125f)
            ...
            TV.m_Componentes["Back"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5f, -0.5f,  -0.25f), new Vector3(-0.5f,  0.5f, -0.25f), new Vector3(0.5f,  0.5f,  -0.25f)
            ...
            TV.m_Componentes["Back"].m_Faces["Left"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5f, -0.5f, -0.25f), new Vector3(-0.5f,  0.5f,  -0.25f), new Vector3(-0.5f,  0.5f, -0.25f + 0.125f)
                }, new Vector3(0.18f, 0.18f, 0.18f),
                TV.m_Position + TV.m_Componentes["Back"].m_Position + TV.m_Componentes["Back"].m_Faces["Left"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.5f, -0.5f,  -0.25f), new Vector3(-0.5f, -0.5f, -0.25f + 0.125f), new Vector3(-0.5f,  0.5f, -0.25f + 0.125f)
                }, new Vector3(0.18f, 0.18f, 0.18f),
                    TV.m_Position + TV.m_Componentes["Back"].m_Position + TV.m_Componentes["Back"].m_Faces["Left"].m_Position),
            };
            ...
            TV.m_Componentes["Back"].m_Faces["Right"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(0.5f, -0.5f, -0.25f + 0.125f), new Vector3(0.5f,  0.5f, -0.25f + 0.125f), new Vector3(0.5f,  0.5f,  -0.25f)
                }, new Vector3(0.18f, 0.18f, 0.18f),
                TV.m_Position + TV.m_Componentes["Back"].m_Position + TV.m_Componentes["Back"].m_Faces["Right"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(0.5f, -0.5f, -0.25f + 0.125f), new Vector3(0.5f, -0.5f,  -0.25f), new Vector3(0.5f,  0.5f, -0.25f)
                }, new Vector3(0.18f, 0.18f, 0.18f),
                    TV.m_Position + TV.m_Componentes["Back"].m_Position + TV.m_Componentes["Back"].m_Faces["Right"].m_Position),
            };
        ...
        public static Objeto CargarFlorero(Vector3 Position = default)
        {
            ...
            Florero.m_Componentes["Base"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.125f,  0.5625f, -0.125f), new Vector3(-0.325f,  1.2625f, -0.225f), new Vector3(0.325f,  1.2625f, -0.225f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                Florero.m_Position + Florero.m_Componentes["Base"].m_Position + Florero.m_Componentes["Base"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.125f,  0.5625f, -0.125f), new Vector3(0.125f,  0.5625f, -0.125f), new Vector3(0.325f,  1.2625f, -0.225f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                    Florero.m_Position + Florero.m_Componentes["Base"].m_Position + Florero.m_Componentes["Base"].m_Faces["Back"].m_Position),
            };
            ...
            Florero.m_Componentes["Base2"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.125f - 0.0150f,  0.9625f, -0.125f + 0.0450f), new Vector3(-0.325f + 0.0450f,  1.2625f, -0.225f + 0.0450f), new Vector3(0.325f - 0.0450f,  1.2625f, -0.225f + 0.0450f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                Florero.m_Position + Florero.m_Componentes["Base2"].m_Position + Florero.m_Componentes["Base2"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.125f - 0.0150f,  0.9625f, -0.125f + 0.0450f), new Vector3(0.125f + 0.0150f,  0.9625f, -0.125f + 0.0450f), new Vector3(0.325f - 0.0450f,  1.2625f, -0.225f + 0.0450f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                    Florero.m_Position + Florero.m_Componentes["Base2"].m_Position + Florero.m_Componentes["Base2"].m_Faces["Back"].m_Position),
            };
            ...
            Florero.m_Componentes["Base2"].m_Faces["TopBack"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.325f,  1.2625f, -0.225f), new Vector3(-0.325f + 0.0450f,  1.2625f, -0.225f + 0.0450f), new Vector3(0.325f - 0.0450f,  1.2625f, -0.225f + 0.0450f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                Florero.m_Position + Florero.m_Componentes["Base2"].m_Position + Florero.m_Componentes["Base2"].m_Faces["TopBack"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.325f,  1.2625f, -0.225f), new Vector3(0.325f,  1.2625f, -0.225f), new Vector3(0.325f - 0.0450f,  1.2625f, -0.225f + 0.0450f)
                }, new Vector3(0.2f, 0.7f, 0.85f),
                    Florero.m_Position + Florero.m_Componentes["Base2"].m_Position + Florero.m_Componentes["Base2"].m_Faces["TopBack"].m_Position),
            };
            ...
            Florero.m_Componentes["Base2"].m_Faces["Tierra"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.125f - 0.0150f,  0.9625f, -0.125f + 0.0450f), new Vector3(-0.125f - 0.0150f,  0.9625f,  0.125f - 0.0450f), new Vector3(0.125f + 0.0150f,  0.9625f,  0.125f - 0.0450f)
                }, new Vector3(00.4f, 0.2f, 0.2f),
        ...
        public static Objeto CargarParlante(Vector3 Position = default)
        {
            ...
            Parlante.m_Componentes["Base"].m_Faces["Back"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.75f, -2.875f, -0.525f), new Vector3(-0.75f, -0.875f, -0.525f), new Vector3(0.75f, -0.875f, -0.525f)
                }, new Vector3(0.1f, 0.1f, 0.1f),
                Parlante.m_Position + Parlante.m_Componentes["Base"].m_Position + Parlante.m_Componentes["Base"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.75f, -2.875f, -0.525f), new Vector3(0.75f, -2.875f, -0.525f), new Vector3(0.75f, -0.875f, -0.525f)
                }, new Vector3(0.1f, 0.1f, 0.1f),
                    Parlante.m_Position + Parlante.m_Componentes["Base"].m_Position + Parlante.m_Componentes["Base"].m_Faces["Back"].m_Position),
            };
            ...
            Parlante.m_Componentes["Base"].m_Faces["Top"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.75f, -0.875f, -0.525f), new Vector3(-0.75f, -0.875f,  0.525f), new Vector3(0.75f, -0.875f,  0.525f)
                }, new Vector3(0.1f, 0.1f, 0.1f),
            ...
            Parlante.m_Componentes["Base"].m_Faces["Bottom"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.75f, -2.875f, -0.525f), new Vector3(-0.75f, -2.875f,  0.525f), new Vector3(0.75f, -2.875f,  0.525f)
                }, new Vector3(0.1f, 0.1f, 0.1f),
                Parlante.m_Position + Parlante.m_Componentes["Base"].m_Position + Parlante.m_Componentes["Base"].m_Faces["Back"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
            ...
            Parlante.m_Componentes["MidRange"].m_Faces["Cuadrado1"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.2f, -1.5f, 0.535f), new Vector3(-0.2f, -1.1f, 0.535f), new Vector3(0.2f, -1.1f, 0.535f)
                ...
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.2f, -1.5f, 0.535f), new Vector3(0.2f, -1.5f, 0.535f), new Vector3(0.2f, -1.1f, 0.535f)
                }, new Vector3(0.6f, 0.6f, 0.6f),
                    Parlante.m_Position + Parlante.m_Componentes["MidRange"].m_Position + Parlante.m_Componentes["MidRange"].m_Faces["Cuadrado1"].m_Position),
            };
            ...
            Parlante.m_Componentes["MidRange"].m_Faces["Cuadrado2"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.1f, -1.4f, 0.545f), new Vector3(-0.1f, -1.2f, 0.545f), new Vector3(0.1f, -1.2f, 0.545f)
                ...
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.1f, -1.4f, 0.545f), new Vector3(0.1f, -1.4f, 0.545f), new Vector3(0.1f, -1.2f, 0.545f)
                }, new Vector3(0.8f, 0.8f, 0.8f),
                    Parlante.m_Position + Parlante.m_Componentes["MidRange"].m_Position + Parlante.m_Componentes["MidRange"].m_Faces["Cuadrado2"].m_Position),
            };
            ...
            Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado1"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.4f, -2.5f, 0.535f), new Vector3(-0.4f, -1.7f, 0.535f), new Vector3(0.4f, -1.7f, 0.535f)
                }, new Vector3(0.6f, 0.6f, 0.6f),
                Parlante.m_Position + Parlante.m_Componentes["Woofer"].m_Position + Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado1"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.4f, -2.5f, 0.535f), new Vector3(0.4f, -2.5f, 0.535f), new Vector3(0.4f, -1.7f, 0.535f)
                }, new Vector3(0.6f, 0.6f, 0.6f),
                    Parlante.m_Position + Parlante.m_Componentes["Woofer"].m_Position + Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado1"].m_Position),
            };
            ...
            Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado2"].m_Triangles = new Dictionary<string, Triangle>()
            {
                ["Trian1"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.3f, -2.4f, 0.545f), new Vector3(-0.3f, -1.8f, 0.545f), new Vector3(0.3f, -1.8f, 0.545f)
                }, new Vector3(0.8f, 0.8f, 0.8f),
                Parlante.m_Position + Parlante.m_Componentes["Woofer"].m_Position + Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado2"].m_Position),
                ["Trian2"] = new Triangle(new List<Vector3>()
                {
                    new Vector3(-0.3f, -2.4f, 0.545f), new Vector3(0.3f, -2.4f, 0.545f), new Vector3(0.3f, -1.8f, 0.545f)
                }, new Vector3(0.8f, 0.8f, 0.8f),
                    Parlante.m_Position + Parlante.m_Componentes["Woofer"].m_Position + Parlante.m_Componentes["Woofer"].m_Faces["Cuadrado2"].m_Position),
            };
